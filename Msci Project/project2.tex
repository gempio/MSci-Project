  ...
  \chapter{Implementation}
    ...
    \section{Server}
      ...
      \subsubsection{Use of specific commands}
        ...
        This works in a similar manner to C++ however with C++, there is almost no way to deal with the server not connecting and the C++ will start to complain about lack of existence of to the server filling up a big chunk of the server data 
